...
% innere Schleife: Erklärung anhand serieller Ausführung, verschachtelte Komp. -> weniger Overhead
% äüßeren schleifen zur iteration über die vectoren (also abschnitte der größe 8), 
% -> calc_count -> nicht über N; bzw über ganze  matrix größe (rest über N)
% temp. variablen um adresse zum speichern nicht jedes mal neu zu berechnen 
% -> aufzeichnung hefter
